  ...
  <div class="mui-fullscreen">
    ...
    <div class="mui-inner-wrap  mui-transitioning">
      ...
      <div id="container" class="container">
            ...
            <div class="slider" style="z-index: 1;" >
							<ul class="slider-main">
								<li :key="index" v-for='(item,index) in imgs' @tap="click_href(item.destinationUrl,item.title)">
            ...
            <div v-if="baseIndex==1" key="one" id="danmu">
              ...
              <div class="dm_content">
                ...
                <div id="content" class="s_scroll">
								<div class="" style="position:  relative;z-index: 1;">
									<div style="width: 100%;margin: 0 auto;">
										<div class="mui-row" style="position:relative;height:1500px;">
											<div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==1?'active':'']" @tap="showHotArea(1,'全部彩种')">
                      ...
                      <div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==19?'active':'']" @tap="showHotArea(19,'收藏')">
											...
											<div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==2?'active':'']" @tap="showHotArea(2,'热门彩')">
												<img src="../assets/images/base/lot_bg2.png">
												<div class="font">
											...
											<div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==3?'active':'']" @tap="showHotArea(3,'时时彩')">
											...
											<div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==4?'active':'']" @tap="showHotArea(4,'快3')">
											...
											<div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==5?'active':'']" @tap="showHotArea(5,'11选5')">
											...
											<div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==6?'active':'']" @tap="showHotArea(6,'PCDD')">
                      ...
                      <div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==7?'active':'']" @tap="showHotArea(7,'快乐十分')">
                      ...
                      <div :class="['mui-col-xs-12 mui-col-sm-12 move',scrAct==8?'active':'']" @tap="showHotArea(8,'六合彩')">
      ...
      <div style="position: fixed;bottom: 0;left: 50%;margin-left: -45px;z-index: 10;">
          ...
          <!-- <a @tap="popArea(1)" class="mui-action-menu">
						<img src="static/images/gengduo.png" style="width: 90px;margin-bottom: -4px;">
					</a> -->
				</div>
      <div class="mui-off-canvas-backdrop" @tap="popArea(2)"></div>
    </div>
            ...
            <li :key="index" v-for="(item,index) in hotArr" class="mui-table-view-cell mui-media">
              <a class="mui-navigate-right" href="javascript:void(0)"  v-if="item.bet_url!=''" @tap='togocontentUrl(item.bet_url,item.gameID,item.pic_url,item.type_name_CN)'>
                ...
                <div class="mui-media-right">
                  <p class="msg">距第{{item.new_issue}}期截止</p>
