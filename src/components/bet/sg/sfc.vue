    ...
    <div id="main">
        ...
        <div class="inner" id="pullrefresh">
          ...
          <ul :class="isNoMsg?'':'inner-ul mui-table-view mui-table-view-chevron'">
            <li :key="index" class="inner-li" v-for='(item,index) in datas' :data-index="item.match_id" :data-select="index" :id="item.id">
              <!--上半部分-->
              <div class="li-top">
                <!--左边-->
        ...
        <div class="inner-hide">
          ...
          <ul>
            <li :key="index" class="inner-hide-li" v-for="(item,index) in datas" :id="item.id">
              <div>
        ...
        <div class="btn2 goNext">
          <div class="btn2-top clearf">
            ...
            <p class="state"><span v-cloak>{{state}}<em>{{state=="游客"?"":"(可用)"}}</em></span></p>
          </div>
        ...
        <div id='sharkit' @click="sharkitFn"></div>
...
<script src="../../../assets/js/sg/sfc.js"></script>

<style src="../../../style/sg/sfc.css" scoped></style>
