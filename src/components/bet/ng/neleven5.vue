                    ...
                    <div class="mui-scroll" style="height: calc(100% - 44px) !important;">
                        <div style="padding: 0 15px">
                            ...
                            <div class="num" @click="showHis(1)">
                                ...
                                <span v-else-if="!recentlyNum||recentlyNum.length==0" style="height:1.5rem;" class="red">数据获取中...</span>
                                <template v-else>
                            ...
                            <div class="mui-row" style="overflow: auto;height: calc(100% - 70px);background: rgb(203, 212, 222);">
                                 <div id="segmentedControlContents" class="mui-col-xs-12 mui-col-sm-12">
                                   <div id="content1" class="mui-control-content right second"  v-show="bet_area_manner.myriabit"><h2>{{$t('第一位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in myriabit">
                                    ...
                                    <div id="content2" class="mui-control-content right second"  v-show="bet_area_manner.kilobit"><h2>{{$t('第二位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in kilobit">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content3" class="mui-control-content right second"  v-show="bet_area_manner.hundreds"><h2>{{$t('第三位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in hundreds">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    ...
                                    <div id="content6" class="mui-control-content right second"  v-show="bet_area_manner.common"><h2>{{right_title[0]}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in numberArr">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content8" class="mui-control-content right second"  v-show="bet_area_manner.common1"><h2>{{right_title[1]}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in numberArr1">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
