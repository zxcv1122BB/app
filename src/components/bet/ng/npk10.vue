                    ...
                    <div class="mui-scroll" style="height: calc(100% - 44px) !important;">
                        <div style="padding: 0 15px">
                            ...
                            <div class="num" @click="showHis(1)">
                                <!-- <span class="red" style="font-size: 1.2rem;color:red" v-if="previousIssue_tips">开奖中...</span> -->
                            ...
                            <div class="mui-row" style="overflow: auto;height: calc(100% - 70px);background: rgb(203, 212, 222);">
                                <div id="segmentedControlContents" class="mui-col-xs-12 mui-col-sm-12">
                                    <div id="content1" class="mui-control-content right second"  v-show="bet_area_manner.myriabit"><h2>{{$t('冠军')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in myriabit">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content2" class="mui-control-content right second"  v-show="bet_area_manner.kilobit"><h2>{{$t('亚军')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in kilobit">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content3" class="mui-control-content right second"  v-show="bet_area_manner.hundreds"><h2>{{$t('季军')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in hundreds">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content4" class="mui-control-content right second"  v-show="bet_area_manner.decade"><h2>{{$t('第四位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in decade">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content5" class="mui-control-content right second"  v-show="bet_area_manner.unit"><h2>{{$t('第五位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in unit">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div class="mui-control-content right second"  v-show="bet_area_manner.sixth"><h2>{{$t('第六位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in sixth">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                     <div class="mui-control-content right second"  v-show="bet_area_manner.seventh"><h2>{{$t('第七位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in seventh">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                     <div class="mui-control-content right second"  v-show="bet_area_manner.eighth"><h2>{{$t('第八位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in eighth">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                     <div class="mui-control-content right second"  v-show="bet_area_manner.nineth"><h2>{{$t('第九位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in nineth">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                     <div class="mui-control-content right second"  v-show="bet_area_manner.tenth"><h2>{{$t('第十位')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in tenth">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div class="mui-control-content right second"   v-show="bet_area_manner.topAsia"><h2></h2><div class="content" style="margin-top:.5rem;"><div class="content-item"  :key="index" v-for="(item,index) in numberArr">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                     ...
                     <div class="bet_detail">
                            <ul>
                                ...
                                <li>若中奖,单注最高中:
									...
									{{present_playId==189?special_sum:parseFloat(singleCoins*orderOdds).toFixed(2)}}
								</span>
                                    {{coinUnit}}
                                </li>
                            </ul>
