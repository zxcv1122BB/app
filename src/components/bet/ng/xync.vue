    ...
    <div id="ssc">
        ...
        <div id="mainArea" v-show="!switchoverType">
            ...
            <div class="info-wrapper clearfix">
                <div class="info-top clearfix">
                    ...
                    <div class="recent">
                        ...
                        <p class="btn_banner" v-if="previousIssue">
                            第<span style="color:red;">{{previousIssue}}</span>期开奖
                            <b class="ico" style="right: 1.6rem;"></b>
                        </p>
                        <p class="banner_num">
                           <span  style="color:red;font-size:1.2rem;line-height:2.5rem;" v-if="previousIssue_tips">开奖中...</span>
                            <span v-else-if="recentlyNum.length==0" style="font-size: 1.5rem;color: red;">数据获取中...</span>
            ...
            <div class="main">
                ...
                <div class="common">
                    <dl class="num1 clearfix bet_area_item bet_area1" v-if="bet_area_manner.myriabit" v-cloak>
                        <dt>{{right_title}}</dt>
                        ...
                        <dd class="second" :style="{'margin-top': multifunctionalbtn?'1rem':'0'}">
                            <div>
                                <ul>
                                    <li v-for="(item,index) in myriabit">
                                        <span :class="{'sel_num':item.isSel}" @touchstart="showBigSelectBall($event,item,index,0)" @touchend="hideBigSelectBall($event)" @touchcancel="hideBigSelectBall($event)" :data-index="index" >{{item.num}}</span>
                                    </li>
                                </ul>
                            </div>
                        </dd>
                    </dl>
                    <dl class="num2 clearfix bet_area_item bet_area1" v-if="bet_area_manner.kilobit" v-cloak>
                        <dt>{{right_title_two}}</dt>
                        <dd class="first" v-if="right_title_two!='拖码'">
                            <div class="titleBtn" >
                                <ul>
                    ...
                    <dl class="num4 clearfix bet_area_item bet_area1" v-if="bet_area_manner.special" v-cloak>
                        <dt>{{$t('红投')}}</dt>
                        <dd class="second">
                            <div>
                                <ul>
