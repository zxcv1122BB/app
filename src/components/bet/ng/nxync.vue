 v-if="localStorage.userName"<template>
<div>
    <div id="container">
    <div id="ssc">
        <!--页面头部-->
                    ...
                    <div class="mui-scroll" style="height: calc(100% - 44px) !important;">
                        <div style="padding: 0 15px">
                            <ul class="mui-row" style="padding: 5px 0;">
                                ...
                                <li style="margin-left:8px;line-height: 30px;color: #fff;font-size: 1rem;float:left;">
                                    <span>[{{pack_coin+coinUnit}}]</span>
                                </li>
                        ...
                        <div class="body" id="mainArea">
                            <div class="mui-row" style="overflow: auto;height: calc(100% - 70px);background: rgb(203, 212, 222);">
                                  <div id="segmentedControlContents" class="mui-col-xs-12 mui-col-sm-12">
                                   <div id="content1" class="mui-control-content right second"  v-show="bet_area_manner.myriabit"><h2>{{right_title}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in myriabit">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content2" class="mui-control-content right second"  v-show="bet_area_manner.kilobit"><h2>{{right_title_two}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in kilobit">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content3" class="mui-control-content right second"  v-show="bet_area_manner.hundreds"><h2>{{right_title_three}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in hundreds">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    ...
                                    <div class="mui-control-content right second"  v-show="bet_area_manner.special"><h2>{{$t('红投')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in numberArr">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                    <div id="content6" class="mui-control-content right second"  v-show="bet_area_manner.common"><h2>{{$t('数投')}}</h2><div class="content"><div class="content-item"  :key="index" v-for="(item,index) in numberArr">
                                        <p><span :class="{'sel_num':item.isSel}"   @click="handleAddClass(item)">{{item.num}}</span></p>
                                        </div></div></div>
                                </div>
                            </div>
...
<script src="../../../assets/js/ng/xync.js"></script>
