            ...
            <div id="mainArea" v-show="!switchoverType">
                ...
                <div class="info-wrapper clearfix">
                    <div class="info-top clearfix">
                        ...
                        <div class="recent">
                            ...
                            <p class="banner_num">
                               <span class="red"  style="font-size:1.2rem;line-height:2.5rem;" v-if="previousIssue_tips">开奖中...</span>
                ...
                <div class="main" id="plie">
                  ...
                  <ul id="gamePlanList" class="animated" @touchmove="gamePlanScoll" @scroll="gamePlanScoll" v-show="showGamePlan==1">
                    ...
                    <div class="common">
                        <dl class="num1 clearfix bet_area_item bet_area1" v-if="bet_area_manner.hundreds" v-cloak>
                            <dt>{{$t('百位')}}</dt>
                            <dd class="first">
                                <div class="titleBtn"  v-show="present_playId!=449&&present_playId!=450">
                                    <ul>
                        ...
                        <dl class="num3 clearfix bet_area_item bet_area1" v-if="bet_area_manner.unit" v-cloak>
                            <dt>{{$t('个位')}}</dt>
                            <dd class="first">
                                <div class="titleBtn"  v-show="present_playId!=449&&present_playId!=450">
                                    <ul>
                        ...
                        <dl class="num4 clearfix bet_area_item bet_area1" v-if="bet_area_manner.common" v-cloak>
                            <dt>{{right_title}}</dt>
                            <dd class="first">
                                <div class="titleBtn">
                                    <ul>
                ...
                <div class="bets_footer">
                    <ul>
                        ...
                        <li>
                            <div>
                                <p v-cloak>合计
                                    <span class="red">{{totalCoins}}</span>
                                  {{coinUnit}}
                                </p>
                                <p v-cloak>可用余额
...
<script src="../../../assets/js/ng/threed.js"></script>
